...
$(".nav-qt .stui-history").hover(function(){$(".nav-qt .h-box").stop().fadeIn(400)},function(){$(".nav-qt .h-box").stop().fadeOut(400)}),$(function(){$(".mjl").click(function(){var a=$(this).hasClass("show")?1:0;a?($(this).removeClass("show"),$(".history-down").stop().slideUp()):($(this).addClass("show"),$(".history-down").stop().slideDown())})});