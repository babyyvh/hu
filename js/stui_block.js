...
var stui = {
	...
	mobile: {
		...
		slide: function() {
			$.getScript("/images/flickity.pkgd.min.js", function() {
	...
	images: {
		lazyload: function() {
			$.getScript("/images/jquery.lazyload.js", function() {
				$(".lazyload").lazyload({
					effect: "fadeIn",
					threshold: 200,
					failurelimit: 15,
		...
		qrcode: function() {
			$("img.qrcode").attr("src", "/statics/img/weiff.jpg")
		}
	},
	common: {
		bootstrap: function() {
			$.getScript("/images/bootstrap.min.js", function() {
		...
		headroom: function() {
			$.getScript("/images/headroom.min.js", function() {
				$("#header-top", function() {
